...
const projects = [
  ...
  { name:'VELENÉ Athleisure', category:'E-Commerce · Moda', desc:'Ecommerce premium con drops limitados, carrito persistente y dashboard de operaciones.', result:'↑ Lanzamiento exitoso · Drops agotados', tags:['Next.js','Stripe','Neon DB'], headline:'Nueva colección\nOversized.', logo:'VELENÉ', url:'velene.club', bg:'linear-gradient(160deg,#0c0a06,#1a1208,#100e08)', overlay:'rgba(200,150,60,0.07)', image:'https://velene.vercel.app/velene-preview.png' },
  { name:'Mirror Calf', category:'E-Commerce · Streetwear', desc:'Tienda online con drops limitados, lookbook editorial y experiencia de compra premium.', result:'↑ Lanzamiento exitoso · Colección agotada', tags:['Next.js','E-Commerce','Editorial'], headline:'Reflection of\nthe Streets.', logo:'MC', url:'mirrorcalf.com', bg:'linear-gradient(160deg,#0a0606,#180808,#100606)', overlay:'rgba(180,30,30,0.07)', image:'https://velene.vercel.app/mf-preview.png' },
