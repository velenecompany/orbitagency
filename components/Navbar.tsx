  ...
  return (
    <>
      <nav style={{
          ...
          {navItems.map(item => (
            <li key={item.label}>
              <Link href={item.href} style={{
                ...
                letterSpacing: '2.5px', color: 'var(--white2)', textDecoration: 'none',
        ...
        <a href={WA} target="_blank" rel="noopener noreferrer" className="nav-desktop" style={{
          background: 'rgba(240,237,232,0.08)', border: '1px solid rgba(240,237,232,0.14)',
          color: 'var(--white)', fontFamily: "'DM Sans', sans-serif", fontSize: '11px',
          letterSpacing: '1px', padding: '11px 22px', borderRadius: '100px',
          transition: 'background 0.2s', textDecoration: 'none', display: 'inline-block',
        }}
      ...
      <div style={{
        ...
        opacity: menuOpen ? 1 : 0, pointerEvents: menuOpen ? 'all' : 'none', transition: 'opacity 0.4s',
      }}>
        {navItems.map((item, i) => (
          <Link key={item.label} href={item.href} onClick={() => setMenuOpen(false)} style={{
            fontFamily: "'Cormorant Garamond', serif", fontSize: '40px', fontWeight: 300,
            letterSpacing: '-1px', color: 'var(--white)', textDecoration: 'none',
        ...
        <a href={WA} target="_blank" rel="noopener noreferrer" style={{
          background: 'rgba(240,237,232,0.08)', border: '1px solid rgba(240,237,232,0.14)',
          color: 'var(--white)', fontFamily: "'DM Sans', sans-serif", fontSize: '12px',
          letterSpacing: '1px', padding: '14px 28px', borderRadius: '100px', marginTop: '16px',
          opacity: menuOpen ? 1 : 0, transition: 'opacity 0.4s 0.28s', textDecoration: 'none',
        }}>Agendar llamada →</a>
      </div>
