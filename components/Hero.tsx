  ...
  return (
    <>
      <div style={{
        ...
        {/* Fade izquierda sobre video */}
        <div style={{
          position: 'absolute',
          left: 0, top: 0, bottom: 0,
          width: '60%',
          background: 'linear-gradient(90deg, #090909 40%, transparent 100%)',
          zIndex: 1,
          pointerEvents: 'none',
        }} />
        ...
        <div style={{
          ...
          height: '40%',
          background: 'linear-gradient(0deg, #090909 0%, transparent 100%)',
          zIndex: 1,
          pointerEvents: 'none',
        }} />
        ...
        <div style={{
          ...
          height: '20%',
          background: 'linear-gradient(180deg, #090909 0%, transparent 100%)',
          zIndex: 1,
          pointerEvents: 'none',
        }} />
        ...
        <div style={{ flex: 1, maxWidth: '680px', paddingTop: '80px', zIndex: 2, position: 'relative' }}>
          <div style={{
            ...
            <span style={{
              ...
              transition: 'width 1s 0.5s', flexShrink: 0,
            }} />
          ...
          <p style={{
            ...
            href="https://wa.me/523312499320?text=Hola%20ORBIT%20%F0%9F%91%8B%20Me%20interesa%20iniciar%20un%20proyecto."
            target="_blank"
            ...
            style={{
              ...
              marginTop: '44px', borderRadius: '100px',
              opacity: showBtn ? 1 : 0,
      ...
      <style>{`
        ...
        @media(max-width:768px) {
          video { width: 100% !important; opacity: 0.3 !important; }
        }
      `}</style>
    </>
  )
