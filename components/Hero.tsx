...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const t2 = setTimeout(() => setShowVideo(true), 600)
  ...
  return (
    <>
      <div style={{
        ...
        {/* Content */}
        <div style={{ flex: 1, maxWidth: '750px', paddingTop: '80px', zIndex: 2, position: 'relative' }}>
          <div style={{
            ...
            <span style={{
              ...
              width: started ? '36px' : '0px', transition: 'width 1s 0.5s', flexShrink: 0,
            }} />
          ...
          <a href="https://wa.me/523312499320?text=Hola%20ORBIT%20%F0%9F%91%8B%20Me%20interesa%20iniciar%20un%20proyecto." target="_blank" rel="noopener noreferrer" style={{
